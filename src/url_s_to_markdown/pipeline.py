"""Pipeline MVP+ : URLs -> groupes .md/.pdf + plan + manifeste + logs."""
...
class RunResult:
    ...
    organization_plan_json: Path
    organization_plan_md: Path
...
def run_pipeline(stats: URLStats, client: HTTPClient, output_root: Path, max_urls: int) -> RunResult:
    ...
    for batch_index, batch_urls in enumerate(batches, start=1):
        ...
        for group in groups:
            ...
            group_dir = groups_root / group_folder_name
